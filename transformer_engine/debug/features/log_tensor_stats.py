...
class LogTensorStats(BaseLogTensorStats):
    ...
    @api_method
    def look_at_tensor_before_process(self, config, layer_name, 
                                      tensor_name, tensor, iteration=None):
        assert type(tensor) not in [Float8Tensor, Float8TensorBase, MXFP8Tensor, MXFP8TensorBase] and tensor.dtype != torch.uint8,\
