...
NVTE_CPU_OFFLOAD_V1 = False


def start_offload(*tensors, offload_base_tensor: bool = False):
    """Stub function for marking tensors ready to be offloaded. Does nothing in v1."""
    pass


def mark_not_offload(*tensors):
    """Stub function to prevent tensors from being offloaded. Does nothing in v1."""
    pass
